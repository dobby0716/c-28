...
var myEngine, myWorld,box5,log3,log4,bird1,bg,sling1;
var ground1,box1,box4,pig2,log2,box2,box3,pig1,log1,log5;
...
function setup() {
  ...
  platform= new ground(120,430,250,300)
  ...
  sling1= new slingshot(bird1.body,{x:350,y:200})
